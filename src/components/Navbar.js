      ...
      <nav className='navbar'>
        <div className='navbar-container'>
          <Link to='/' className='navbar-logo' onClick={closeMobileMenu}>
            <div className="logo">
            <motion.svg className="logo-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 840.000000 691.000000" 
            ...
            <g transform="translate(0.000000,691.000000) scale(0.100000,-0.100000)"
              ...
              0 51 -2 100 -57z"/>
              <motion.path d="M1359 6403 c-1 -54 -2 -491 -3 -970 l-1 -873 482 0 483 0 0 190 0
              190 -285 0 -285 0 0 205 0 205 168 2 167 3 3 187 2 188 -167 2 -168 3 -3 193
              -2 192 285 0 285 0 0 190 0 190 -480 0 -480 0 -1 -97z" variants={item}/>
              ...
              <motion.path d="M4710 5530 l0 -970 200 0 200 0 2 466 3 467 90 -467 90 -466 197 0
              198 0 0 970 0 970 -195 0 -195 0 -2 -482 -3 -483 -52 265 c-29 146 -71 363
              -94 483 l-42 217 -198 0 -199 0 0 -970z" variants={pathVariants} />
              <motion.path d="M5860 6310 l0 -190 65 0 65 0 0 -590 0 -590 -65 0 -65 0 0 -190 0
              -190 545 0 545 0 0 970 0 970 -545 0 -545 0 0 -190z m700 -780 l0 -590 -90 0
              -90 0 0 590 0 590 90 0 90 0 0 -590z" variants={pathVariants}  />
              <motion.path d="M7230 3405 l0 -3095 70 0 70 0 0 3095 0 3095 -70 0 -70 0 0 -3095z"variants={item}/>
              ...
              0 -45 -4 -45 -14z"/>
              <motion.path d="M7760 6439 c0 -52 2 -60 17 -57 9 2 20 14 23 28 5 23 7 23 13 6 7
              ...
              -19 -8 -19 -61z"variants={item} />
              <motion.path d="M2380 3375 l0 -975 505 0 505 0 0 440 0 440 -195 0 -195 0 0 -245 0
              -245 -110 0 -110 0 0 590 0 590 305 0 305 0 0 190 0 190 -505 0 -505 0 0 -975z" variants={pathVariants}/>
              <motion.path d="M3562 3378 l3 -973 488 -3 487 -2 0 975 0 975 -490 0 -490 0 2 -972z
              m588 2 l0 -590 -95 0 -95 0 0 590 0 590 95 0 95 0 0 -590z" variants={pathVariants}/>
              ...
              -9z"/>
              <motion.path d="M2839 2193 c-5 -28 -6 -1581 -1 -1716 l5 -167 461 2 461 3 3 188 2
              187 -280 0 -280 0 0 190 0 190 165 0 165 0 0 185 0 185 -165 0 -165 0 0 190 0
              190 280 0 280 0 0 190 0 190 -465 0 c-256 0 -466 -3 -466 -7z" variants={pathVariants}/>
              <motion.path d="M3940 2169 c0 -17 20 -219 45 -448 55 -502 75 -688 115 -1061 16
              ...
              -31z"/>
              <motion.path d="M5100 2010 l0 -190 45 0 45 0 0 -565 0 -565 -45 0 -45 0 0 -190 0
              -190 295 0 295 0 0 190 0 190 -45 0 -45 0 0 565 0 565 45 0 45 0 0 190 0 190
              -295 0 -295 0 0 -190z" variants={item}/>
              <motion.path d="M5860 1255 l0 -945 545 0 545 0 0 275 0 275 -205 0 -205 0 0 -85 0
              -86 -137 3 -138 3 -3 753 -2 752 -200 0 -200 0 0 -945z"variants={pathVariants}/>
              <motion.path d="M7650 2050 l0 -150 110 0 110 0 0 45 0 45 55 0 55 0 0 -80 0 -81
              -165 -255 -165 -256 0 -109 0 -109 275 0 275 0 0 105 0 105 -156 0 c-137 0
              -155 2 -150 15 3 9 73 121 156 249 l150 233 0 197 0 196 -275 0 -275 0 0 -150z"variants={item}/>
              <motion.path d="M2380 1905 l0 -35 83 -1 82 -1 -82 -39 c-81 -38 -83 -40 -83 -74 l0
              -35 150 0 150 0 0 35 0 35 -82 1 -83 1 83 39 c80 38 82 40 82 74 l0 35 -150 0
              -150 0 0 -35z"variants={pathVariants}/>
              <motion.path d="M2515 1664 c-60 -6 -116 -13 -122 -13 -9 -1 -13 -23 -13 -76 0 -69 2
